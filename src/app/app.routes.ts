...
import { DisclaimerRouteComponent } from './routes/disclaimer-route/disclaimer-route.component';

export const routes: Routes = [
    { path: "", component: LandingPageRouteComponent, title: "Reduced Lens" },
    { path: "news", component: NewsRouteComponent, title: "News" },
    { path: "disclaimer", component: DisclaimerRouteComponent, title: "Disclaimer" },
